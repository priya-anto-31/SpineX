...
function Posture() {
  ...
  const handleReUpload = () => {
    ...
    setPreview(null);
    setShowCobb(false);
    setShowPostureRecommendation(false);
  };

  const treatmentRef = useRef(null);
  const [showPostureRecommendation, setShowPostureRecommendation] =
    useState(false);
  const handlePostureRecommendation = (label) => {
    setPostureLabel(label);
    setShowPostureRecommendation(true);
    setTimeout(() => {
    ...
    <div className="scroll-container">
      {loading ? (
        ...
        <>
          ...
          {prediction && (
            ...
            >
              <Prediction
                ...
                handlePostureRecommendation={handlePostureRecommendation}
              />
            </motion.div>
          )}
          ...
          {showPostureRecommendation && postureLabel && (
            <motion.div
              ref={treatmentRef}
              ...
              animate="visible"
            >
              <Treatment disorderLabel={postureLabel} />
            </motion.div>
          )}
        </>
      )}
